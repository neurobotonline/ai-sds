                ...
                <div class="card mb-4 mb-xl-10">
                    <div class="card-header cursor-pointer">
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0"><i class="<?php _e( $config['icon'] )?>" style="color: <?php _e($config['color'])?>"></i> <?php _e("Vk профиль")?></h3>
                        </div>
                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button class="btn btn-primary"><?php _e("Добавить профиль VK")?></button>
                    </div>
                </div>
            </form>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="note">
                        ...
                        <a href="<?php _ec( get_module_url("oauth") )?>" class="btn btn-outline btn-outline-dashed bg-white"><i class="<?php _ec( $config['icon'] )?>" style="color: <?php _ec( $config['color'] )?>"></i> <?php _e("Re-connect with Vk")?></a>
                    </div>
                </div>
