							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
									<div class="flex-grow-1 me-2 text-over-all">
										...
										<a href="<?php _ec( base_url("facebook_pages/oauth") )?>" class="text-danger fw-semibold d-block fs-12"><?php _e( "Re-login required" )?></a>
										<?php endif ?>
									</div>
								</div>
							...
							<div class="text-center px-4">
					            ...
					            <div>
					            	<a class="btn btn-primary btn-sm b-r-30" href="<?php _e( base_url($config['id'].'/oauth') )?>" >
		                            	<i class="fad fa-plus"></i> <?php _ec("Добавить страницу")?>
		                            </a>
					            </div>
					        </div>
						</div>
